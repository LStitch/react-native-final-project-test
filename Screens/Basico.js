    ...
    return (
        <View style={styles.container}>
            <ScrollView>
                ...
                />
                <Text style={styles.titulo}>Teoría de Líneas</Text>
                ...
                <Text style={styles.negritas}> “No morir y Farmear”. </Text>
                ...
                <Text style={styles.negritas}> “Conseguir 100 Creeps más que el contrario y echar a perder la partida”. </Text>
                ...
                tiempo posible.
                <Text style={styles.negritas}> “El Farmeo nunca es lo más importante” </Text>
                ...
                <Text style={styles.negritas}> “Morir en un Gank en Early es como entregar la primera ala de Dragón” </Text>
                </Text>
            </ScrollView>
